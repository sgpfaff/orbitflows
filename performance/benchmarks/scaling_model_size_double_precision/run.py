"""Driver for the `scaling_train_size_2` benchmark.

Differs from `scaling_train_size` by having more training data.
...
from performance.benchmarks.common import expand_sweep, load_config, run_sweep  # noqa: E402
