...
from orbitflows.dynamics import H_sho, H, sho_potential
import torch
...
guess_ps, true_aa = generate_sho_orbits(n_orbits=n_orbits, omega=omega_guess, t_end=t_end, 
...
scheduler = partial(ReduceLROnPlateau, mode='min', patience=50, 
                      ...
                      eps=epsilon_float64)
# Define the model
targetPotential = partial(sho_potential, omega=omega_true)
